...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-gklobsk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-gklobsk.containers.anotherwebservice.com/
...
```
git clone git@github.com:insert0name/container-gklobsk.git
cd container-gklobsk
```
...
```
docker attach container-gklobsk
```
